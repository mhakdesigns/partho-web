        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              Hi, my name is <span className="yellow">Muhammed Hisham Ak </span>
              ...
              as well as have knowledge in MERN STACK
          ...
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              <li className="social-icons">
                <a
                  href="https://github.com/hishamak18"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/muhammed-hisham-ak-947b2b245/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                  aria-label="linkedin"
              ...
              <li className="social-icons">
                <a
                  href="https://www.instagram.com/hisham._ak/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour home-social-icons"
